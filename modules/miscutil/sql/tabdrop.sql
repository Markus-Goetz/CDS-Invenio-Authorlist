...
DROP TABLE IF EXISTS aidAUTHORNAMES;
DROP TABLE IF EXISTS aidAUTHORNAMESBIBREFS;
DROP TABLE IF EXISTS aidDOCLIST;
DROP TABLE IF EXISTS aidREALAUTHORS;
DROP TABLE IF EXISTS aidREALAUTHORDATA;
DROP TABLE IF EXISTS aidVIRTUALAUTHORS;
DROP TABLE IF EXISTS aidVIRTUALAUTHORSDATA;
DROP TABLE IF EXISTS aidVIRTUALAUTHORSCLUSTERS;
DROP TABLE IF EXISTS aidPERSONID;
...
DROP TABLE IF EXISTS aulORGANIZATIONS;
